...
void SoPoly::curveEval(GsArray<GsVec>& curveV, int segments, int mode){
	if(V.size() > 2)
		switch(mode){
		case 1:	eval_lagrange(V, curveV, segments); break;
		case 2:	eval_bezier(V, curveV, segments); break;
		case 3:	eval_bspline(V, curveV, segments); break;
		case 4:	eval_crspline(V, curveV, segments); break;
		case 5:	eval_bospline(V, curveV, segments); break;
		}

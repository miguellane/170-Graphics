...
# include "so_cylindernorm.h"

SoCylinderNorm::SoCylinderNorm()
 {
   _numpoints = 0;
 }

void SoCylinderNorm::init ( const GlProgram& prog)
 {
...
void SoCylinderNorm::build ( int nface, bool smooth ){
...
void SoCylinderNorm::draw ( GsMat& tr, GsMat& pr){
   // Draw Lines:
   glUseProgram ( prog );
